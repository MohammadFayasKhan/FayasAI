...
```mermaid
graph TD
    Home[1. HOME: Waiting for User] -->|Press & Hold Button| Record[2. RECORDING: Speak into INMP441 Microphone]
    Record -->|Release Button| Whisper[3. WHISPER STT: Convert Speech to Text whisper-large-v3]
    Whisper -->|Transcribed Text| Llama[4. LLAMA 3.3 LLM: Generate Smart Response llama-3.3-70b-versatile]
    Llama -->|AI Text Response| Response[5. DISPLAY: Scroll and Read Response on OLED]
    Response -->|Tap Button| Home
```
